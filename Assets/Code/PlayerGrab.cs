...
public class PlayerGrab : MonoBehaviour
{
    ...
    void Start()
    {
        MusikGame.Instance.Play("PopupSFX", 1);
    }
    ...
    void Update()
    {
        ...
        if (objInHand)
        {
            objInHand.GetComponent<SpriteRenderer>().sortingOrder = 7;
        }
    }
    ...
    IEnumerator SmoothOut()
    {
        ...
        else
        {
            ...
            if (change)
            {
                ...
                originGameobject = objInHand;
                Smooth();
                originGameobject.GetComponent<SpriteRenderer>().sortingOrder = 5;
            }
            //change = false;
            returnComplete = false;
    ...
    void Facing()
    {
        ...
        {
            playerHand.up = direction;
            playerHand.eulerAngles = new Vector3(0, 0, Mathf.Clamp(playerHand.eulerAngles.z, 35, 90));
